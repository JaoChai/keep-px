            ...
            {PRESET_THEMES.map((theme) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${theme.style.bg_color} 50%, ${theme.style.accent_color} 50%)`,
                  }}
                  onClick={() =>
                    onChange({
                      ...style,
                      bg_color: theme.style.bg_color,
                      accent_color: theme.style.accent_color,
                      text_color: theme.style.text_color,
                    })
                  }
                />
              );
