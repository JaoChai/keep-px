          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="flex h-11 w-[320px] items-center justify-center gap-2.5 rounded-md bg-foreground text-sm font-medium text-background transition-opacity hover:opacity-90"
              >
