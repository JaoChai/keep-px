...
CREATE INDEX idx_admin_grants_customer ON admin_credit_grants(customer_id);
CREATE INDEX idx_admin_grants_admin ON admin_credit_grants(admin_id);
CREATE INDEX idx_admin_grants_created ON admin_credit_grants(created_at DESC);
